...
=======
<<<<<<< HEAD:Index.qmd
>>>>>>> a678ce7ce31eff7aadabc76fe646b4259c23dd49
---
...
format: html
editor: visual
css: styles.css  # Note that this is now a top-level field
---
...
# Assuming data_summary is your data frame
data_summary %>%
  kable("html") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) 
```
...
>>>>>>> 3827d8976e5e977f7b03faf75ba9059165140e91:index.qmd
>>>>>>> a678ce7ce31eff7aadabc76fe646b4259c23dd49
